...
<body>
	...
	$(function(){
		...
		$(document).on('click', '.btn-mod-comment',function(){
			...
			var co_num = $(this).data('num');
			var button ='<button class="btn btn-outline-info btn-mod-insert" data-num="'+co_num+'">댓글 수정</button>'
		...
		$(document).on('click','.btn-rep-comment',function(){
			...
			var buttonStr = '<button class="btn btn-success btn-rep-insert" data-num="'+$(this).data('num')+'">등록</button>';
			$(this).parent().children('button').hide(); 
