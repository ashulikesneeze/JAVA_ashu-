...
public class ExbStudentImportant{
	...
	public ExbStudentImportant(int grade, int classNum, int num, String name, int kor, int eng, int math) {
		this.grade = grade;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExbStudentImportant other = (ExbStudentImportant) obj;
